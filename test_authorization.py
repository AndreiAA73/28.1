...
class TestValidRegistrationRT:
    ...
    # 13
    @allure.feature('Авторизяция по номеру телефна (несуществующий)')
    ...
    # 14
    @allure.feature('Авторизяция по номеру телефна (несуществующий пароль)')
    ...
    # 15
    @allure.feature('Авторизяция по логину (XSS-инъекция)')
